...
import com.example.elderCare.app.call.CallFragment;
import com.example.elderCare.app.ui.fragments.UsersFragment;
import com.example.elderCare.app.ui.fragments.toggleFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void fragChange(int tabId) {
        ...
        if (tabId == R.id.toolmap){
            ...
            find_and_hide_fragment("setting_fragment");
            find_and_hide_fragment("call_fragment");
        } else if (tabId == R.id.toolcontact) {
